    ...
    return(
        <div className={classes.posts}>
            <div className={classes.post}>
              <h2 className={classes.title}>Перевір свої знання</h2>
              <h3 className={classes.posted}>Проект засновано в жовтні 2020 р.</h3>
              ...
              <div className={classes.meta}>
                <p>Filed under <a href="#" className={classes.category}>Uncategorized</a> | <a href="#" className={classes.comment}>1 Comment &raquo;</a></p>
              </div>
            </div>
            <div className={classes.post}>
              <h2 className={classes.title}>А ти знаєш?</h2>
              <div className={classes.story}>
                <blockquote>
                    <ul>
                        <li>
